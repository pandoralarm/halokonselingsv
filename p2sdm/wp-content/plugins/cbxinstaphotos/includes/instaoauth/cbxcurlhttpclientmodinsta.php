<?php
	 ...
	 * @author    Joomboxr ( http://codeboxr.com )
	 * @copyright Copyright (C) 2011-2016 http://codeboxr.com. All rights reserved.
	 * @license   http://www.gnu.org/copyleft/gpl.html GNU/GPL
	 * @ help: http://codeboxr.com/product/instagram-photo-display-for-joomla
	 */
	class CurlHttpClientModInsta {
		/**
		 * Default User-Agent
		 *
		 * @var string
		 */
		const DEFAULT_USER_AGENT = 'Instagram PHP Implementation http://codeboxr.com/';
		...
		public function setMethod( $method = self::GET ) {
			switch ( $method ) {
				...
				case self::DELETE :
					...
					break;
				default:
					throw new CurlHttpClientModInstaException( 'Method not supported' );
			}
		}
	...
	class CurlHttpClientModInstaException extends Exception {
	}
