<div id="tab_panel_feed_box" class="panel qligg_options_panel <# if (data.panel != 'tab_panel_feed_box') { #>hidden<# } #> " >
  ...
  <div class="options_group <# if (!data.box.display){ #>disabled-field<# } #>"> 	 
    ...
    <p class="form-field"> 
      <label><?php esc_html_e('Box text color', 'insta-gallery'); ?></label>
      <input data-alpha="true" name="box[color_text]" type="text" placeholder="#000000" value="{{data.box.color_text}}" class="color-picker"/>
      <span class="description"><small><?php esc_html_e('Color which is displayed on box text', 'insta-gallery'); ?></small></span> 
      <span class="description hidden"><small><?php esc_html_e('(This is a premium feature)', 'insta-gallery'); ?></small></span>
    </p>
  </div>
