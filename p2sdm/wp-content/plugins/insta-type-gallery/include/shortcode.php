...
function awl_insta_gallery_shortcode($post_id) {
	...
	wp_enqueue_script('itg-jpages-js', ITG_PLUGIN_URL . 'assets/js/itg-jPages.js');	
	wp_enqueue_script('itg-imagesloaded-pkgd-js', ITG_PLUGIN_URL .'assets/js/imagesloaded.pkgd.js', array('jquery'), '' , true);
	wp_enqueue_script('itg-isotope-js', ITG_PLUGIN_URL .'assets/js/isotope.pkgd.js', array('jquery'), '', false);
	
	// awp custom bootstrap css
	wp_enqueue_style('itg-bootstrap-css', ITG_PLUGIN_URL .'assets/css/bootstrap.css');
	wp_enqueue_style( 'itg-jpages-css', ITG_PLUGIN_URL . 'assets/css/jPages.css' );
	wp_enqueue_style( 'itg-animate-css', ITG_PLUGIN_URL . 'assets/css/animate.css' );
