...
function expert_plumber_fonts_url(){
	$font_url = '';
	$font_family = array();
	$font_family[] = 'Roboto:100,100i,300,300i,400,400i,700,700i,900,900i';
...
function expert_plumber_scripts() {
	...
	$custom_css = '
		.logo {
			margin-top: '.esc_attr($expert_plumber_logo_top_margin).'px;
		...
		#services-section {
			padding-top: '.esc_attr($expert_plumber_service_section_padding).'px;
