...
class Expert_Plumber_Loader {
	 ...
	 * @return void
	 */
	public function expert_plumber_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function expert_plumber_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function expert_plumber_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function expert_plumber_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->expert_plumber_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function expert_plumber_load( $class ) {
